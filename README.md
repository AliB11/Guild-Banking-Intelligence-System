...
- تمام صفحات (میز کار، ماتریس اصناف، قیف سرنخ، ماشین‌حساب، منابع) در مرورگر روی یک corpus نمونه دترمینیستیک کار می‌کنند؛ هیچ فایل `.env` یا سرویس خارجی برای دمو لازم نیست.
- پنجره‌ی گزارش‌دهی خودکار با تقویم جلالی واقعی حرکت می‌کند: شش ماه اخیر تا ماه جاری (اگر امروز شهریور ۱۴۰۵ باشد، «دوره جاری» دقیقاً شهریور ۱۴۰۵ است). ارقام واحدها نمونه‌اند؛ کاتالوگ منابع با جاب ماهانه پس از انتشار گزارش اصناف به‌روز می‌شود.
...
هیچ رقم KPI از آینهٔ خبری وارد مدل نمی‌شود. آینه‌ها فقط برای کشف «گزارش منتشر شد» هستند.
...
3. پنجرهٔ شش‌ماهه جلالی را با ماه جاری هم‌تراز می‌کند و **ماهنامه هوش اصناف** را بازتولید می‌کند.
