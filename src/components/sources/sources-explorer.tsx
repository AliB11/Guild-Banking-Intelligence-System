    ...
    <div className="space-y-6">
      ...
      <Card className="animate-fade-up">
        ...
        <CardContent className="grid grid-cols-1 gap-3 md:grid-cols-2 text-[12px] leading-6 text-slate-400">
          ...
          <p>
            <b className="text-persian-200">نامه یک‌صفحه‌ای:</b> ساخته شد — صفحه «نامه ستاد» همان ارقام مرداد را برای چاپ یک صفحه جمع می‌کند. شهریور هنوز گزارش ندارد.
          </p>
          <p>
          ...
          <p>
            <b className="text-slate-200">جدول رسته شاپرک:</b> اگر شاپرک گردش MCC را منتشر کند، اطلس می‌تواند سود رسته را رتبه‌بندی کند. تا آن روز فقط سیاست کارمزد/اینتا هست.
          </p>
        </CardContent>
      </Card>
