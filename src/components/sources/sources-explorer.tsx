    ...
    <div className="space-y-6">
      ...
      <Card className="animate-fade-up">
        ...
        <CardContent className="grid grid-cols-1 gap-3 md:grid-cols-2 text-[12px] leading-6 text-slate-400">
          <p>
            <b className="text-slate-200">کارت تغییر ماه:</b> بعد از هر واکشی موفق، فقط رسته‌هایی که ربع BCG یا ضریب اینتاکدشان عوض شده
            به‌صورت «چه چیز این ماه عوض شد» روی میز کار بیاید.
          </p>
          <p>
            <b className="text-slate-200">نامه شعبه یک‌صفحه‌ای:</b> از روی ماهنامه، یک PDF/چاپ برای رئیس شعبه با سه اقدام مشخص ساخته شود.
          </p>
          <p>
            <b className="text-slate-200">گراف زنجیره تأمین:</b> وقتی داده رابطه‌ای واقعی بیاید، پیشنهاد گام/اعتبار اسنادی از روی مشتری و تأمین‌کننده صادر شود — نه از روی داده ساختگی.
          </p>
          <p>
            <b className="text-slate-200">آزمایش اثر اقدام:</b> برای «تماس امروز» نرخ تبدیل و زمان رسیدن به رسوب ثبت شود تا امتیاز سرنخ فقط تئوری نماند.
          </p>
        </CardContent>
      </Card>
